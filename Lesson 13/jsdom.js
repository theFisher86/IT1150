...
function Homework()
{
    ...
    */
	var thing = document.getElementById("copyright");//this is the Element
    var text = thing.style.background = "yellow";
    ...
    */
	var thing2 = document.getElementsByTagName("button");
    for(var i=0;i<thing2.length;i++){
        thing2[i].style.background = "lightgreen";
		thing2[i].style.color = "darkgreen"; //Added this for readability
    }
    ...
    */
	var thing3 = document.getElementsByTagName("p");
    for(var i=0;i<thing3.length;i++){
        thing3[i].className = "green";
    }
    ...
    */
    var parent = document.getElementById("parent");
    var thing4 = document.createElement("a");
    thing4.innerText="Link";
    thing4.classList.add("ClassA");
	thing4.href = "http://www.tri-c.edu";
    parent.appendChild(thing4);
}
